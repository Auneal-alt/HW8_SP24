...
class PumpCurve_GUI_Class(Ui_Form, qtw.QWidget):  # class for PumpCurve_GUI inherits from Ui_Form & qtw.QWidget
    def __init__(self):  # constructor for this class
        ...
        self.myPump = Pump_Controller()  # JES Missing Code #create a pump controller object
    ...
    def OpenFile(self):
        ...
        '''
        fname = qtw.QFileDialog.getOpenFileName(self,
                                                'Open File')  # JES Missing Code # use qtw.QFileDialog.getOpenFileName
        oTF = len(fname[0]) > 0
        if oTF:
