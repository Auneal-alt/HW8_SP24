...
class rankineController():
    def __init__(self, *args):
        ...
        """
        self.Model = rankineModel()  # JES Missing Code  # In MVC pattern, the controller should hold a reference to the model
        self.View = rankineView()  # JES Missing Code  # In MVC pattern, the controller should hold a reference to the view
