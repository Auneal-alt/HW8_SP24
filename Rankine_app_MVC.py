...
class MainWindow(qtw.QWidget, Ui_Form):
    def __init__(self):
        ...
        self.RC = rankineController(self.input_widgets,
                                    self.display_widgets)  # JES Missing Code  # instantiate a rankineController object and pass as arguments the two lists of widgets to be unpacked into the View
    ...
    def Calculate(self):
        self.RC.updateModel()  # JES Missing Code #call the updateModel() method of the controller
        pass

    def SelectQualityOrTHigh(self):
        self.RC.selectQualityOrTHigh()  # JES Missing code #call the selectQualityOrTHigh() methond of the controller
        pass

    def SetPlotVariables(self):
        self.RC.updatePlot()  # JES Missing Code # call the updatePlot() method of the controller
        pass

    def SetUnits(self):
        self.RC.updateUnits()   # JES Missing Code # call the updateUnits() method of the controller
        pass

    def setNewPHigh(self):
        self.RC.setNewPHigh()   # JES Missing Code # call the setNewPHigh() function of the controller
        pass

    def setNewPLow(self):
        self.RC.setNewPLow()   # JES Missing Code # call the setNewPLow() function of the controller
        pass
